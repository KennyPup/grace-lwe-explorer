    ...
    with zipfile.ZipFile(out_zip, 'w', compression=zipfile.ZIP_DEFLATED) as zf:
        ...
        for vname in ['ppt', 'aet', 'q']:
            ...
            for yr in unique_years:
                ...
                fname = f'annual/TC_{vname.upper()}_{yr}_{bbox_label}.tif'
        ...
        for vname in ['ppt', 'aet', 'q']:
            ...
            for m_idx, val in enumerate(mm_vals):
                ...
                fname = f'monthly_means/TC_{vname.upper()}_MeanMonthly_{mon_num}_{mon_name}_{bbox_label}.tif'
                zf.writestr(fname, tif_bytes)
                total_files += 1
        ...
        readme_lines += [
            ...
            '  monthly_means/    — 12 TIFs per variable, climatological mean for each',
            '                      calendar month across all years in the record',
            '',
            'File naming:',
            '  annual/         TC_<VAR>_<year>_<location>.tif',
            '  monthly_means/  TC_<VAR>_MeanMonthly_<MM>_<Mon>_<location>.tif  (VAR = PPT/AET/Q/BF)',
            '',
